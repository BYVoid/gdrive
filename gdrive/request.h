...
public:
    ...
    void rename(const string id, const string etag, const string newname);
    
private:
    string do_request(const string url, Dict * fields, Dict * headers);
    Dict do_head(const string url, Dict * headers, string method);
    string do_raw_post(const string url, const string post_data, Dict * headers, string method);
    XmlNode get_resource(string url);
    string post_contents(const string url, const string post_data);
    string put_contents(const string url, const string post_data);
